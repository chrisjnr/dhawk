            ...
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="index.php?r=projects%2Fcreate"><i class="fa fa-circle-o"></i> Reassign a Project</a></li>
                        <li><a href="index.php?r=projects"><i class="fa fa-circle-o"></i> View All Projects</a></li>
                        <li><a href="index.php?r=projects"><i class="fa fa-circle-o"></i> Delete A Project</a></li>
          ...
          <i class="fa fa-angle-left pull-right"></i>
            ...
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="index.php?r=companies"><i class="fa fa-circle-o"></i> View All Companies</a></li>
            ...
            <span class="pull-right-container">
              ...
              <small class="label pull-right bg-red">5</small>
                ...
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-folder"></i> <span>Blacklist</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
                    </a>
                    <ul class="treeview-menu">
                        ...
                        <li><a href="pages/examples/404.html"><i class="fa fa-circle-o"></i> Black List a Company </a></li>
                        <li><a href="pages/examples/500.html"><i class="fa fa-circle-o"></i> View Black List</a></li>
